  ...
  return (
    <div className="absolute top-40 left-20 p-4 w-[350px] h-[350px] bg-white rounded-[8px] shadow-[0px_0px_6px_1px_#00000024]">
      ...
      <form action="" className="mt-4 flex flex-col gap-3">
        <div>
          <label className={`block text-[14px] ${(isDisabledStart) ? ' text-[#44546f]' : ' text-[#0c66e4]'} font-bold`} htmlFor="datum">From </label>
        ...
        <div>
          <label className={`block text-[14px] ${(isDisabledEnd) ? ' text-[#44546f]' : ' text-[#0c66e4]'} font-bold`} htmlFor="datum">To</label>
          <div className="mt-2 flex gap-2 items-center">
